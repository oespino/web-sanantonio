    ...
    return (
        <div className="text-green-800">
            ...
            <p className="py-4">
                ...
                con la <span className="font-bold">Ley 19/2013, de 9 de diciembre, de transparencia, acceso a la información pública y
                    buen gobierno</span> y la <span className="font-bold">Ley 12/2014, de 26 de diciembre, de transparencia y de acceso a la
            ...
            <p className="py-4 pl-4">
                <a target="_blank" href="https://www.boe.es/buscar/act.php?id=BOE-A-1889-4763&amp;tn=1&amp;p=20230301">
            ...
            <p className="pl-4">
                <a target="_blank" href="https://www.boe.es/buscar/act.php?id=BOE-A-2013-12887">
            ...
            <p className="py-4">
                ...
                como se establece el artículo 6 de la <a target="_blank" href="https://www.boe.es/buscar/act.php?id=BOE-A-2014-12328&amp;tn=1&amp;p=20240220" className="font-bold">Ley 27/2014, de 27 de noviembre, del Impuesto sobre
                    Sociedades <ExternalLinkLogo size={16} className="inline mb-1" /></a>,
                y el artículo 35.4 de la <a target="_blank" href="https://www.boe.es/buscar/act.php?id=BOE-A-2003-23186" className="font-bold">Ley 58/2003, de 17 de diciembre, General Tributaria <ExternalLinkLogo size={16} className="inline mb-1" /></a>.
            </p>
