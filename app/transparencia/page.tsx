...
const sections = [
    ...
    { id: "administradoresydirectivos", label: "Administradores y directivos" },
    { id: "serviciosyprocedimientos", label: "Servicios y procedimientos" },
    { id: "economicofinanciera", label: "Económico – Financiera" },
    { id: "contratos", label: "Contratos" },
    { id: "convenios", label: "Convenios" },
    { id: "ayudasysubvenciones", label: "Ayudas y subvenciones" },
];
        ...
        <div className="text-green-800">
            ...
            <p className="py-4">
                ...
                con la <a target="_blank" href="https://www.boe.es/eli/es/l/2013/12/09/19/con" className="font-bold underline underline-offset-2">Ley 19/2013, de 9 de diciembre, de transparencia, acceso a la información pública y
                    buen gobierno <ExternalLinkLogo size={16} className="inline mb-1" /></a> y la <a target="_blank" href="https://www.boe.es/eli/es-cn/l/2014/12/26/12" className="font-bold underline underline-offset-2">Ley 12/2014, de 26 de diciembre, de transparencia y de acceso a la
            ...
            <p className="py-4">
                Más información: <a target="_blank" href="https://transparenciacanarias.org/" className="font-bold underline underline-offset-2">Comisionado de Transparencia del Gobierno de Canarias. <ExternalLinkLogo size={16} className="inline mb-1" /></a>
            </p>
            <p className="py-4">
            ...
            <nav aria-label="Contenido de la página" className="my-6">
                <p className="font-bold">En esta página</p>
                <ul className="mt-2 flex flex-wrap gap-x-6 gap-y-1">
                    {sections.map((section) => (
                        <li key={section.id}>
                            <a href={"#" + section.id} className="underline underline-offset-2">{section.label}</a>
                        </li>
                    ))}
                </ul>
            </nav>
            ...
            <ul className="list-disc pl-8 space-y-2">
                <li>
                    <a target="_blank" href="https://www.boe.es/eli/es/rd/1889/07/24/(1)/con" className="font-bold underline underline-offset-2">
                        Real Decreto de 24 de julio de 1889 por el que se publica el Código
                        Civil. <ExternalLinkLogo size={16} className="inline mb-1 mx-1" />
                    </a>
                </li>
                <li>
                    <a target="_blank" href="https://www.boe.es/eli/es/l/2013/12/09/19/con" className="font-bold underline underline-offset-2">
                        Ley 19/2013, de 9 de diciembre, de transparencia, acceso a la información pública y buen
                        gobierno. <ExternalLinkLogo size={16} className="inline mb-1 mx-1" />
                    </a>
                </li>
            </ul>
            ...
            <h2 id="administradoresydirectivos" className={subtitle({ class: "text-green-800 font-bold mt-6 scroll-mt-20" })}>Administradores y directivos</h2>
            <p className="py-4">
            ...
            <p className="py-4">
                ...
                según la <a target="_blank" href="https://www.boe.es/eli/es/l/2023/02/20/2/con" className="font-bold underline underline-offset-2">Ley 2/2023, de 20 de febrero, reguladora de la protección de las personas que
                    informen sobre infracciones normativas y de lucha contra la corrupción <ExternalLinkLogo size={16} className="inline mb-1" /></a>,
                pues no alcanza la cifra de 50 trabajadores, la empresa dispone del correo <a target="_blank" href="mailto:transparencia@avicolasanantonio.com" className="font-bold underline underline-offset-2">transparencia@avicolasanantonio.com</a> como
            ...
            <h2 id="contratos" className={subtitle({ class: "text-green-800 font-bold mt-6 scroll-mt-20" })}>Contratos</h2>
            <p className="py-4">
            ...
            <ul className="list-disc pl-8 space-y-1">
                <li>No se ha formalizado ningún contrato con ninguna entidad pública.</li>
                <li>No se ha desistido o renunciado a ningún contrato.</li>
                <li>No se realizaron modificaciones sobre los contratos formalizados.</li>
            </ul>


            <h2 id="convenios" className={subtitle({ class: "text-green-800 font-bold mt-6 scroll-mt-20" })}>Convenios</h2>
            <p className="py-4">
            ...
            <ul className="list-disc pl-8 space-y-1">
                ...
                <li>No se ha desistido o renunciado a ningún convenio y/o encomienda de gestión.</li>
                <li>
            ...
            <h2 id="ayudasysubvenciones" className={subtitle({ class: "text-green-800 font-bold mt-6 scroll-mt-20" })}>Ayudas y subvenciones</h2>
            <p className="py-4">
            ...
            <ul className="list-disc pl-8">
                <li>
                    <a target="_blank" href="/subvenciones2024.csv" className="font-bold underline underline-offset-2">
                        Listado de subvenciones. <CSVLogo size={16} className="inline mb-1 mx-1" />
                    </a>
                </li>
            </ul>
        </div >
