...
export default function AboutPage() {
	return (
		<div className="text-green-800">
			...
			<p className="py-4">
				Somos una empresa avícola familiar que comenzó en los años 70 con un pequeño lote de gallinas en el sureste de la isla. Desde entonces, y hasta ahora, dos generaciones más tarde, nuestra filosofía ha sido siempre la de producir un producto de calidad, y que llegue en perfectas condiciones de frescura al cliente.
			</p>
			<p className="py-4">
				Desde siempre hemos criado nuestras propias pollitas, desde que se reciben con un día de edad hasta que se acaba su siclo productivo. Esto hace que podamos llevar un control de calidad a lo largo de toda la vida de la gallina, que nos permite conseguir un producto de calidad.
			</p>
			<p className="py-4">
